...
print("\(transaction1.type) \(transaction1.amount)")
print("\(transaction2.type) \(transaction2.amount)")
...
print(personBankAccount.owner)
print(personBankAccount.transactions)
